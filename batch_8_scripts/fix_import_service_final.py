...
try:
    ...
    print(f"=== Testando processamento final do Lote #{batch.id} ===")
    ...
    if len(df) > 0:
        ...
        # 2. Para PF, cnpj deve ser vazio/None
        dados_corrigidos['cnpj'] = None
        
        # 3. Corrige CEP removendo ponto decimal
        ...
        # 4. Corrige estado_civil para valor válido
        ...
        # 5. Corrige tipo_conta para valor válido
        ...
        # 6. Corrige status para valor válido
        ...
        # 7. Corrige mes_averbacao para formato AAAA-MM
        ...
        # 9. Remove campos que não devem estar no modelo
        campos_para_remover = []
        for campo in dados_corrigidos.keys():
            if campo not in [f.name for f in Cadastro._meta.fields]:
